...
{
       0,    55,    55,    59,    60,    63,    64,    70,    74,    75,
      79,    87,    88,    92,   100,   107,   108,   111,   114,   119,
     124,   128,   134,   140,   141,   142,   146,   149
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "TWOGREAT", "GREAT",
  "NEWLINE", "LESS", "GREATGREAT", "GREATAMPERSAND", "PIPE", "AMPERSAND",
  "GREATGREATAMPERSAND", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "argument_list", "argument",
  "command_word", "pipe_list", "iomodifier_opt", "io_modifier_list",
...
{
      36,    -1,    -6,    -6,     2,    33,    -6,    -6,    -5,    -6,
       4,    -6,    -6,    -6,     8,    21,    39,    41,    42,    43,
      -6,    13,    44,    45,    22,    -6,    -6,    -6,    -6,    -6,
      -6,    -6,    -6,     9,    -6,    -6,    -6,    -6,    -6
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      24,    27,    10,     0,     0,    17,    18,    22,    19,    20,
      21,    26,    23,     0,    13,    11,    15,     6,     7
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -6,    -6,    -6,    15,    -6,    26,    -6,    -6,    -6,    -6,
      17,    40,    -6
};
...
{
      14,    15,    12,    16,    17,    18,    11,   -25,    19,    14,
      15,    25,    16,    17,    18,    23,    38,    19,    14,    15,
      13,    16,    17,    18,    26,    31,    19,    14,    15,    37,
      16,    17,    18,    -2,     1,    19,     2,     1,    32,     2,
       3,    32,    27,     3,    28,    29,    30,    34,     2,    36,
      24
};

static const yytype_uint8 yycheck[] =
{
       5,     6,     0,     8,     9,    10,     7,    12,    13,     5,
       6,     3,     8,     9,    10,    11,     7,    13,     5,     6,
       5,     8,     9,    10,     3,    12,    13,     5,     6,     7,
       8,     9,    10,     0,     1,    13,     3,     1,    21,     3,
       7,    24,     3,     7,     3,     3,     3,     3,     3,    23,
      10
};
...
static const yytype_uint8 yystos[] =
{
      ...
      23,     7,     0,    17,     5,     6,     8,     9,    10,    13,
      24,    25,    20,    11,    25,     3,     3,     3,     3,     3,
       3,    12,    24,    26,     3,    21,    19,     7,     7
};
...
#line 92 "shell.y" /* yacc.c:1646  */
    ...
    expandWildcardsIfNecesary((char *)(yyvsp[0].cpp_string)->c_str());
  }
